### O que é? 
- Dashboard interativa com usuário a partir de uma API da OpenWeather, que produz gráfico de previsão de 5 dias e uma tabela de previsão a cada 3 horas. 

***O que é necessário instalar*** 
- Versão estável atualizada do Python a partir do 3.x
...
* src/processamento.py: Tratamento de dados
